  ...
  return (
    <div className="min-h-screen bg-white dark:bg-brand-ink text-brand-charcoal dark:text-gray-200 font-avenir transition-colors">
      ...
      <header className="pt-40 pb-24 px-6 sm:px-10 text-center opacity-0 animate-fadeIn" style={{ animationDelay: '0ms', animationFillMode: 'forwards' }}>
        <h1 className="text-5xl mb-6 text-brand-charcoal dark:text-white">Resume</h1>
      ...
      <div className="bg-brand-highlight/70 dark:bg-brand-charcoal/40 border border-brand-charcoal/10 dark:border-brand-charcoal/40 p-8 rounded-3xl mb-12 transition-colors">
        <div
          className="flex flex-wrap justify-center gap-12 text-brand-charcoal/80 dark:text-gray-200 opacity-0 animate-fadeIn"
          style={{ animationDelay: '0ms', animationFillMode: 'forwards' }}
        >
          <div className="text-center">
            <Mail className="mx-auto mb-2 text-brand-primary" />
            <div className="font-semibold tracking-wide uppercase text-xs text-brand-charcoal/70 dark:text-gray-200">Email</div>
            <div>me@nateking.dev</div>
          </div>
          <div className="text-center">
            <MapPin className="mx-auto mb-2 text-brand-primary" />
            <div className="font-semibold tracking-wide uppercase text-xs text-brand-charcoal/70 dark:text-gray-200">Location</div>
            <div>Omaha, NE</div>
          </div>
          <div className="text-center">
            <Globe className="mx-auto mb-2 text-brand-primary" />
            <div className="font-semibold tracking-wide uppercase text-xs text-brand-charcoal/70 dark:text-gray-200">Portfolio</div>
            <div>nateking.dev</div>
          </div>
          <div className="text-center">
            <Award className="mx-auto mb-2 text-brand-primary" />
            <div className="font-semibold tracking-wide uppercase text-xs text-brand-charcoal/70 dark:text-gray-200">Experience</div>
            <div>7+ Years</div>
          </div>
        </div>
        ...
        {/* Divider */}
        <div
          className="my-6 w-3/4 mx-auto h-px bg-brand-charcoal/20 dark:bg-brand-charcoal/35 origin-center scale-x-0 animate-drawLine"
          style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}
        />

        {/* Tagline */}
        <p
          className="text-center italic text-brand-charcoal/70 dark:text-gray-200 opacity-0 animate-fadeUp"
        ...
        >
          ...
          <section className="mb-12">
            <h2 className="text-3xl mb-6 text-brand-charcoal dark:text-white">Professional Summary</h2>
          ...
          {/* Experience */}
          <section className="mb-12">
            <h2 className="text-3xl mb-6 text-brand-charcoal dark:text-white">Experience</h2>
            
            <div className="space-y-8">
              {/* Job 1 */}
              <div className="border-l-4 border-brand-primary/35 dark:border-brand-primary/50 pl-6">
                <div className="flex flex-wrap justify-between items-start mb-2">
                  <h3 className="text-xl font-semibold text-brand-charcoal dark:text-white">Senior Software Engineer, Generative AI</h3>
                  <span className="text-brand-charcoal/70 dark:text-gray-200">2025 - Present</span>
                </div>
                <div className="text-brand-charcoal/70 dark:text-gray-200 mb-3">FNBO · Omaha, NE</div>
                <ul className="list-disc list-inside space-y-2 text-brand-charcoal/80 dark:text-gray-200">
              ...
              <div className="border-l-4 border-brand-primary/35 dark:border-brand-primary/50 pl-6">
                <div className="flex flex-wrap justify-between items-start mb-2">
                  <h3 className="text-xl font-semibold text-brand-charcoal dark:text-white">Lead Software Engineer, Salesforce</h3>
                  <span className="text-brand-charcoal/70 dark:text-gray-200">2019 - 2025</span>
                </div>
                <div className="text-brand-charcoal/70 dark:text-gray-200 mb-3">FNBO · Omaha, NE</div>
                <ul className="list-disc list-inside space-y-2 text-brand-charcoal/80 dark:text-gray-200">
              ...
              <div className="border-l-4 border-brand-primary/35 dark:border-brand-primary/50 pl-6">
                <div className="flex flex-wrap justify-between items-start mb-2">
                  <h3 className="text-xl font-semibold text-brand-charcoal dark:text-white">Senior System Administrator</h3>
                  <span className="text-brand-charcoal/70 dark:text-gray-200">2017 - 2019</span>
                </div>
                <div className="text-brand-charcoal/70 dark:text-gray-200 mb-3">FNBO · Omaha, NE</div>
                <ul className="list-disc list-inside space-y-2 text-brand-charcoal/80 dark:text-gray-200">
          ...
          {/* Technical Skills */}
          <section className="mb-12">
            <h2 className="text-3xl mb-6 text-brand-charcoal dark:text-white">Technical Skills</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/90 dark:bg-brand-ink/50 border border-brand-charcoal/10 dark:border-brand-charcoal/40 p-6 rounded-3xl transition-colors shadow-lg">
                <h3 className="text-lg font-semibold text-brand-charcoal dark:text-white mb-3">Frontend</h3>
                <div className="flex flex-wrap gap-2">
                  {['React', 'JavaScript', 'TypeScript', 'HTML5', 'CSS3', 'Tailwind CSS', 'Vue.js', 'Next.js'].map(skill => (
                    <span key={skill} className="bg-brand-highlight/80 dark:bg-brand-charcoal/40 px-3 py-1 rounded-full text-sm text-brand-charcoal/80 dark:text-gray-100">
                      {skill}
                    </span>
                  ))}
                </div>
              ...
              <div className="bg-white/90 dark:bg-brand-ink/50 border border-brand-charcoal/10 dark:border-brand-charcoal/40 p-6 rounded-3xl transition-colors shadow-lg">
                <h3 className="text-lg font-semibold text-brand-charcoal dark:text-white mb-3">Backend</h3>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-white/90 dark:bg-brand-ink/50 border border-brand-charcoal/10 dark:border-brand-charcoal/40 p-6 rounded-3xl transition-colors shadow-lg">
                <h3 className="text-lg font-semibold text-brand-charcoal dark:text-white mb-3">AI/ML</h3>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-white/90 dark:bg-brand-ink/50 border border-brand-charcoal/10 dark:border-brand-charcoal/40 p-6 rounded-3xl transition-colors shadow-lg">
                <h3 className="text-lg font-semibold text-brand-charcoal dark:text-white mb-3">Tools & Other</h3>
                <div className="flex flex-wrap gap-2">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/90 dark:bg-brand-ink/50 border border-brand-charcoal/10 dark:border-brand-charcoal/40 p-6 rounded-3xl transition-colors shadow-lg">
                <h3 className="text-xl font-semibold text-brand-charcoal dark:text-white mb-2">Smart Code Review Tool</h3>
                <p className="text-brand-charcoal/80 dark:text-gray-200 mb-3">
      ...
      <footer className="border-t border-brand-charcoal/10 dark:border-brand-charcoal/45 mt-12 py-6 text-center text-sm text-brand-charcoal/60 dark:text-gray-200">
