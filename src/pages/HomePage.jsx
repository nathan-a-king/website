    ...
    <div className="relative min-h-screen bg-brand-cream dark:bg-brand-ink text-brand-charcoal dark:text-brand-cream font-sans transition-colors overflow-hidden">
      ...
      <section className="relative pt-44 pb-28 px-6 sm:px-10 opacity-0 animate-fadeIn" style={{ animationDelay: '0ms', animationFillMode: 'forwards' }}>
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 mb-8 rounded-lg bg-brand-soft dark:bg-brand-ink/80 border border-brand-gray-border dark:border-white/10 text-xs uppercase tracking-[0.35em] font-medium text-brand-gray-medium dark:text-brand-gray-light">
            <span>Strategist. Designer. Engineer.</span>
          </div>
          <p className="text-xl sm:text-2xl text-brand-gray-medium dark:text-brand-gray-light mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <Link
              to="/contact"
              className="px-6 py-3 border border-brand-gray-border dark:border-white/15 text-brand-charcoal dark:text-brand-cream rounded-lg hover:bg-brand-soft dark:hover:bg-white/5 transition-all duration-200 font-medium text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-terracotta/40"
            >
              Get in Touch
            </Link>
          </div>
      ...
      {/* Featured Content */}
      <section className="relative py-24 px-6 sm:px-10 bg-brand-soft dark:bg-brand-charcoal/20 opacity-0 animate-fadeIn transition-colors" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
        <BackgroundPattern variant="grid" className="text-brand-charcoal" />
        <div className="max-w-5xl mx-auto relative">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-serif font-light text-brand-charcoal dark:text-brand-cream inline-block relative">
              Latest Thoughts
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {loading ? (
              ...
              Array.from({ length: 3 }).map((_, index) => (
                <div key={index} className="bg-brand-cream dark:bg-brand-ink p-6 rounded-lg border border-brand-gray-border dark:border-white/10 animate-pulse">
              ...
              latestPosts.map((post, index) => (
                ...
                >
                  <Card className="relative border border-brand-gray-border dark:border-white/10 hover:border-brand-terracotta/30 dark:hover:border-brand-terracotta/40 transition-all duration-200 cursor-pointer h-full bg-brand-cream dark:bg-brand-ink rounded-lg overflow-hidden">
                    <CardContent className="px-6 pt-8 pb-6 h-full flex flex-col">
                      <article className="flex-1 flex flex-col">
                        <header className="mb-4">
                          <h3 className="text-xl font-serif font-normal mb-3 text-brand-charcoal dark:text-brand-cream leading-snug group-hover:text-brand-terracotta dark:group-hover:text-brand-terracotta transition-colors duration-200">
                            {post.title}
                          </h3>
      ...
      <section className="py-24 px-6 sm:px-10 opacity-0 animate-fadeIn" style={{ animationDelay: '400ms', animationFillMode: 'forwards' }}>
        <div className="max-w-3xl mx-auto">
          <div className="relative bg-brand-soft dark:bg-brand-charcoal/10 rounded-lg border border-brand-gray-border dark:border-white/10 p-10 sm:p-12">
            <div className="text-center space-y-6">
              <h2 className="text-3xl font-serif font-light text-brand-charcoal dark:text-brand-cream">
                Building the Future of Human-AI Collaboration
              </h2>
              <p className="text-lg text-brand-gray-medium dark:text-brand-gray-light leading-relaxed">
              ...
              <Link
                to="/about"
                className="inline-block px-6 py-3 border border-brand-gray-border dark:border-white/15 text-brand-charcoal dark:text-brand-cream rounded-lg hover:bg-brand-cream dark:hover:bg-white/5 transition-all duration-200 font-medium text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-terracotta/40"
              >
      ...
      <footer className="relative border-t border-brand-gray-border dark:border-white/10 mt-20 py-8 text-center">
        <div className="text-sm text-brand-gray-light dark:text-brand-gray-light">
