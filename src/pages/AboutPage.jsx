  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-text-primary font-sans transition-colors">
      ...
      <header className="pt-40 pb-24 px-6 sm:px-10 text-center opacity-0 animate-fadeIn" style={{ animationDelay: '0ms', animationFillMode: 'forwards' }}>
        <h1 className="text-5xl font-serif font-light mb-6 text-brand-text-primary">About</h1>
      ...
      <main className="px-6 sm:px-10 pb-8 opacity-0 animate-fadeIn" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
        <div className="max-w-3xl mx-auto prose prose-lg prose-headings:text-brand-charcoal dark:prose-headings:text-brand-cream prose-p:text-brand-gray-medium dark:prose-p:text-brand-gray-light">
          <div className="bg-brand-surface border border-brand-border p-8 rounded-lg mb-12 transition-colors">
            <p className="text-lg leading-relaxed text-brand-text-secondary m-0">
          ...
          <h2 className="text-3xl font-serif font-light mb-6 text-brand-text-primary">My Focus</h2>
          ...
          <h2 className="text-3xl font-serif font-light mb-6 text-brand-text-primary">Current Work</h2>
          ...
          <ul className="list-disc list-inside mb-8 space-y-2 text-brand-text-secondary">
          ...
          <h2 className="text-3xl font-serif font-light mb-6 text-brand-text-primary">Let's Connect</h2>
          ...
          <div className="bg-brand-surface border border-brand-border p-6 rounded-lg transition-colors">
            <p className="text-brand-text-secondary m-0">
