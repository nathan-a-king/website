...
export default function HomePage() {
  return (
    <div className="relative min-h-screen bg-white text-black font-avenir">
      ...
      {/* Featured Content */}
      <section className="py-20 px-6 bg-gray-50 opacity-0 animate-fadeIn" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <h3 className="text-xl font-semibold mb-3">Beyond Chatbots</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <h3 className="text-xl font-semibold mb-3">Interface Evolution</h3>
              <p className="text-gray-600 mb-4">
      ...
      <section className="py-20 px-6 opacity-0 animate-fadeIn" style={{ animationDelay: '400ms', animationFillMode: 'forwards' }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link 
            to="/about"
            className="inline-block px-6 py-3 border border-gray-300 text-black rounded-lg hover:bg-gray-50 transition font-medium"
          >
